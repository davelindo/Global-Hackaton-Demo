  ...
  render() {
    return (
        <div>
                    ...
                    <li className="list-group-item" style={{ padding: '0px 5px', width: '100%' }}>
                        <div className="table-responsive" style={{ width: '100%' }}>
                            <table className="table">
                                <tbody style={{ width: '100%' }}>
                                    <tr style={{ width: '100%' }}>
                                        <td style={{ width: '15%', padding: '5px' }}><i className="material-icons d-flex justify-content-center align-items-center align-content-center m-auto rubberBand animated" style={{ fontSize: '32px', padding: '12px', color: '#56aa1c' }}>card_travel</i></td>
                                        <td style={{ width: '60%', padding: '5px' }}>
                                            <h5 style={{ margin: '0px 0px 5px' }}>Trip to Paris</h5>
                                            <h6 className="text-muted">$1000 of $2000 (50%)</h6>
                                        </td>
                                        <td style={{ width: '25%', padding: '5px 10px' }}><button className="btn btn-success" type="button" style={{ padding: '8px 12px', width: '100%', margin: '6px 0px 0px 0px' }}>Contribute</button></td>
                                    </tr>
                                    <tr style={{ width: '100%' }}>
                                        <td style={{ width: '15%', padding: '5px' }}><i className="icon ion-university d-none d-flex justify-content-center align-items-center align-content-center m-auto rubberBand animated" style={{ fontSize: '32px', padding: '12px', color: '#9b301c' }}></i></td>
                                        <td style={{ width: '60%', padding: '5px' }}>
                                            <h5 style={{ margin: '0px 0px 5px' }}>MBA Tuition</h5>
                                            <h6 className="text-muted">$3000 of $12000 (25%)</h6>
                                        </td>
                                        <td style={{ width: '25%', padding: '5px 10px' }}><button className="btn btn-success" type="button" style={{ padding: '8px 12px', width: '100%', margin: '6px 0px 0px 0px' }}>Contribute</button></td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody style={{ width: '100%' }}>
                                    <tr style={{ width: '100%' }}>
                                        ...
                                        <td style={{ width: '60%', padding: '5px' }}>
                                            ...
                                            <h6 className="text-muted">$3000 of $4000 (75%)</h6>
                                        </td>
                                        <td style={{ width: '25%', padding: '5px 10px' }}><button className="btn btn-success" type="button" style={{ padding: '8px 12px', width: '100%', margin: '6px 0px 0px 0px' }}>Contribute</button></td>
                                    </tr>
                                </tbody>
            ...
            <section>
                    <button className="btn btn-primary d-flex flex-row ml-auto" type="button" style={{ margin: '15px 17px', fontSize: '25px', padding: '0px 12px 4px 12px' }}><Link to="/newGoal" className="d-flex flex-row ml-auto" style={{color: 'white', textDecoration: 'none'}}>+ </Link></button>
            </section>
        </div>
    );
  }
